...
from quickbooks_master_sync.quickbooks_master_sync.sync.compare_balances import _fetch_quickbooks_balances, _fetch_erpnext_balances, _compare_balances
...
def get_columns(filters):
    return [
        ...
        {
            "fieldname": "matched_accounts",
            "label": _("Matched Accounts"),
            "fieldtype": "Int",
            "width": 150
        },
        {
        ...
        # Asset
        { "fieldname": "total_asset_qb", "label": _("Asset QB"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_asset_erp", "label": _("Asset ERP"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_asset_diff", "label": _("Asset Diff"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        # Liability
        { "fieldname": "total_liability_qb", "label": _("Liability QB"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_liability_erp", "label": _("Liability ERP"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_liability_diff", "label": _("Liability Diff"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        # Equity
        { "fieldname": "total_equity_qb", "label": _("Equity QB"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_equity_erp", "label": _("Equity ERP"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_equity_diff", "label": _("Equity Diff"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        # Income
        { "fieldname": "total_income_qb", "label": _("Income QB"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_income_erp", "label": _("Income ERP"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_income_diff", "label": _("Income Diff"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        # Expense
        { "fieldname": "total_expense_qb", "label": _("Expense QB"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_expense_erp", "label": _("Expense ERP"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        { "fieldname": "total_expense_diff", "label": _("Expense Diff"), "fieldtype": "Currency", "options": "currency", "width": 120 },
        {
...
def get_data(as_of_date, tolerance):
    ...
    try:
        ...
        frappe.log_error(f"Failed to fetch QB balances: {str(e)}", "QuickBooks Balance Overview")
        return []
    ...
    for row in qs.company_settings:
        ...
        # Button logic
        view_details_html = """<button class="btn btn-xs btn-default" onclick='frappe.route_options={{"company": "{0}", "as_of_date": "{1}", "run": 1}}; frappe.set_route("quickbooks-balance-comparison");'>{2}</button>""".format(company, as_of_date, _("View Details"))
