...
from .base import QuickbooksBaseObject, QuickbooksManagedObject, QuickbooksTransactionEntity, Ref


class TaxRateDetail(QuickbooksBaseObject):
	class_dict = {"TaxRateRef": Ref}
...
class TaxRateList(QuickbooksBaseObject):
	list_dict = {"TaxRateDetail": TaxRateDetail}
