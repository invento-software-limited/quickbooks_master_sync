from .base import QuickbooksTransactionEntity, Ref, QuickbooksBaseObject, ToJsonMixin, FromJsonMixin
...
class InventoryAdjustmentLineDetail(QuickbooksBaseObject):
    ...
    def __init__(self):
        super(InventoryAdjustmentLineDetail, self).__init__()
        self.ItemRef = None
        self.ClassRef = None
        self.QtyDiff = 0
        self.NewQty = 0
...
class InventoryAdjustmentLine(DetailLine):
    class_dict = {
        "InventoryAdjustmentLineDetail": InventoryAdjustmentLineDetail
    }
