...
from .base import CustomField, LinkedTxn, MarkupInfo, QuickbooksBaseObject, Ref
...
class DiscountLine(DetailLine):
	class_dict = {"DiscountLineDetail": DiscountLineDetail}
...
class SubtotalLine(DetailLine):
	class_dict = {"SubtotalLineDetail": SubtotalLineDetail}
...
class DescriptionLine(DetailLine):
	class_dict = {"DescriptionLineDetail": DescriptionLineDetail}
...
class SaleItemLine(DetailLine):
	class_dict = {"SalesItemLineDetail": SalesItemLineDetail}
